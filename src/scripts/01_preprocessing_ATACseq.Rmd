...
knitr::opts_knit$set(root.dir="/icgc/dkfzlsdf/analysis/B080/quintera/Projects/scCATseq_ATAC_RNA")
...
hist(atac.sce$total_features, xlab="Number of peaks", main="",
     breaks=20, col="grey80", ylab="Number of cells")
...
atac.metadata$feature.drop <- isOutlier(atac.sce$total_features, nmads=3, type="lower", log=TRUE)
